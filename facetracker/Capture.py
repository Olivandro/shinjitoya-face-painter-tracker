...
if __name__ == "__main__":
    ...
    current_model = "/Users/Olivandro/Sites/face_landmark_factory-master/model/facial_landmark_cnn.pb"

    # Currently this only captures whats on the screen...
    # To do
    # 1. Amend to view image file (either jpg or png)
